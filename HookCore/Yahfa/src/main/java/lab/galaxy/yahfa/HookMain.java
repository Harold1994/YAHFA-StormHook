...
public class HookMain {
    ...
    public static void doHookDefault() {
        try {
            Class<?> hookInfoClass = Class.forName("com.storm.hook.HookInfo");
    ...
    public static void findAndBackupAndHook(Class targetClass, String methodName, String methodSig,
        ...
        try {
            ...
            findAndBackupAndHook(targetClass, methodName, methodSig, isStatic, hook, backup);//最终向底层替换代码传入的参数
        }
        catch (Exception e) {
            e.printStackTrace();
        }
